...
public class Post_Fragment extends Fragment {
    ...
    public static Post_Fragment newInstance(boolean param1, String[] param2) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mData = getArguments().getStringArray(ARG_PARAM2);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mErrorMessageDisplay = (TextView) view.findViewById(R.id.post_error_message_display);
        mPostListView = (ListView) view.findViewById(R.id.postListView);

        if (!mError) {
            showListDataView();
            PostListAdapter adapter = new PostListAdapter
                    (getActivity(), R.layout.post_item, PostListDataPump.getData(mData));
            ListView postListView = (ListView) view.findViewById(R.id.postListView);
